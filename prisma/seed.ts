...
// Prisma 7.x: Use driver adapter for PostgreSQL connection
  ...
  for (const character of characters) {
    await prisma.character.create({
      data: {
        ...
        description: `${character.name} — ${character.title}. A ${character.rarity} ${character.element} ${character.role} Lightbearer.`,
        ...
        factionRelation: character.faction ? {
