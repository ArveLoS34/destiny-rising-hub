  ...
  private buildIndex() {
    ...
    characters.forEach((char) => {
      this.addToIndex({
        ...
        icon: char.icon,
        image: char.portrait,
        tags: [char.element, char.role, char.rarity, char.weaponType, char.faction].filter(Boolean) as string[],
        metadata: {
    ...
    teams.forEach((team) => {
      this.addToIndex({
        ...
        tags: [team.template, ...team.members.map((m: any) => m.characterName)],
        metadata: {
    ...
    materials.forEach((material) => {
      this.addToIndex({
        ...
        icon: material.icon,
        tags: [material.rarity, material.category, ...material.sources.map((s: any) => s.type)],
        metadata: {
